...
Biology is undergoing a data generating revolution with data being generated faster than can be analyzed and understood in biologically meaningful ways. This is partly due to the emphasis on novel data sets rather than novel analyses and partly due to biologists being under trained in analysis, math and programming. I think there should be more of an emphasis on developing models to understand the data that we already have. In turn, these models should be used to help decide what experiments (if any) to do next. Of course these models can be conceptual, statistical, or empirical but having a common framework to work in. This is especially true when dealing with questions I am interested in: interactions. During my graduate work I tried to choose questions that were both basic and 

My graduate work focused on basic questions in the climate change literature dealing with environmental and developmental interactions affecting plant carbon and nitrogen metabolism. I tried to choose physiological questions that 

Interactions is a theme that has directed my research since I was an undergraduate. 
